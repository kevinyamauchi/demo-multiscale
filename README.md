...
To run the demo, first make some example data. This will make some gaussian blobs in a 125x500x500 volume, with voxel scales of 4×1×1 (Z×Y×X). The data is written to `example.ome.zarr` in the current directory.
